...
--SET IDENTITY_INSERT dbo.Concepto_Cobro OFF
INSERT INTO dbo.Concepto_Cobro (  id, nombre, tasaInteresesMoratorios, DiaDeCobro, qDiasVencidos, EsImpuesto, EsRecurrente, EsFijo)
SELECT *
